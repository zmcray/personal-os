...
A personal AI operating system I designed and built on Claude (Cowork, Anthropic's attended desktop-agent surface, plus Claude Code for terminal work). I run McRay Group, a small acquisition holding company; this system is its back office. It runs my working day end to end: morning launch, call prep, capture routing, CRM hygiene, memory consolidation, evening synthesis, weekly planning, and a monthly audit of itself.
